...
INSERT INTO user (email, password, role) VALUES ('test@example.com', '$2a$10$D4Oqk5i5E3e0Zg/CIXkhuOeTPo4sQEmKOe3V0y/B.GOo7x4jNXn/S', 'user'); -- password is 'password' encrypted using bcrypt
...
INSERT INTO grah_laxmi (id, account_number, name, city, aadhar_number, has_bpl_card) VALUES
(1, '1234567890', 'Anita Sharma', 'Mumbai', '1234-5678-9101', 'True'),
(2, '0987654321', 'Sunita Patel', 'Delhi', '2345-6789-1011', 'False'),
(3, '1122334455', 'Kamla Devi', 'Bangalore', '3456-7891-0112','True');
...
INSERT INTO user (email, password, role) VALUES ('test@example.com', 'password', 'test-user');
